...
func decodeCheckTokenResponse(resp *http.Response) (res CheckTokenRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &CheckTokenNoContent{}, nil
	case 401:
		// Code 401.
		return &UnauthenticatedResponse{}, nil
	case 500:
...
func decodeGetUserByIdResponse(resp *http.Response) (res GetUserByIdRes, _ error) {
	...
	case 404:
		// Code 404.
		return &UserNotFoundResponse{}, nil
	case 500:
		// Code 500.
		return &InternalErrorResponse{}, nil
	}
