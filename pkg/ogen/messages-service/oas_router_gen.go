	...
	default:
		...
		case '/': // Prefix: "/messages"
			...
			if len(elem) == 0 {
				switch r.Method {
				case "GET":
					s.handleListMessagesRequest([0]string{}, elemIsEscaped, w, r)
				case "POST":
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						s.handleGetMessageByIdRequest([1]string{
							args[0],
						}, elemIsEscaped, w, r)
					case "PUT":
		...
		case '/': // Prefix: "/messages"
			...
			if len(elem) == 0 {
				...
				case "GET":
					...
					r.summary = "Get messages for chat"
				...
				case "POST":
					...
					r.summary = "Send new message to chat"
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "DELETE":
						...
						r.summary = "Delete message from chat"
						...
						return r, true
					case "GET":
						r.name = GetMessageByIdOperation
						r.summary = "Get message in chat"
						r.operationID = "getMessageById"
						r.pathPattern = "/messages/{messageId}"
						r.args = args
						r.count = 1
						return r, true
					case "PUT":
						r.name = UpdateMessageOperation
						r.summary = "Update message in chat"
