...
```
cd existing_repo
git remote add origin https://gitlab.crja72.ru/gospec/go13/go_13.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.crja72.ru/gospec/go13/go_13/-/settings/integrations)
